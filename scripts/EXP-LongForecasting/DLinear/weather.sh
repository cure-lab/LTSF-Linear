...
python -u run_longExp.py \
  ...
  --enc_in 21 \
  --des 'Exp' \
  --itr 1 --batch_size 16  >logs/LongForecasting/DLinear_Weather_$seq_len'_'192.log
...
python -u run_longExp.py \
  ...
  --enc_in 21 \
  --des 'Exp' \
  --itr 1 --batch_size 16  >logs/LongForecasting/DLinear_Weather_$seq_len'_'336.log
